    ...
    <main className="min-h-screen bg-white py-8 px-4 font-sans text-gray-900">
      <div className="max-w-md mx-auto space-y-6">
        ...
        <div className="text-center">
          <div className="text-5xl text-red-900 mb-2">🐾</div>
          <h1 className="text-3xl font-bold">SOS Véto+</h1>
          <div className="inline-block bg-red-50 text-red-900 px-3 py-1 rounded-full text-sm font-semibold mt-2">Urgences animales 24h/24</div>
        </div>
        ...
        {!isAnalyzed ? (
          ...
          /* Zone après clic : Choix de l'animal */
          <div className="space-y-4 animate-in fade-in duration-500">
            <div className="text-center font-bold">Quel est votre animal ?</div>
              ...
              <div className="grid grid-cols-2 gap-3">
                {[
                  ...
                  <div 
                    ...
                    className={`p-4 border rounded-xl cursor-pointer transition-all ${selectedPlan === plan.name ? 'border-red-900 shadow-md' : 'border-gray-200'}`}
                  >
